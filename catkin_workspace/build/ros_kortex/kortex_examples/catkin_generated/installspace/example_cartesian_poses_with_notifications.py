...
class ExampleCartesianActionsWithNotifications:
    ...
    def main(self):
        ...
        if success:
            ...
            my_constrained_pose.target_pose.x = 0.646
            my_constrained_pose.target_pose.y = -.0346
            my_constrained_pose.target_pose.z = 0.42
            my_constrained_pose.target_pose.theta_x = -53.7
            my_constrained_pose.target_pose.theta_y = 0
            my_constrained_pose.target_pose.theta_z = -11.6
